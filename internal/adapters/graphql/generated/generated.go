...
var sources = []*ast.Source{
	{Name: "../schema/note.graphql", Input: `type Note {
    id: ID!
    title: String!
    content: String!
}
...
func (ec *executionContext) field_Mutation_createNote_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNCreateNoteInput2WISPᚋinternalᚋadaptersᚋgraphqlᚋmodelᚐCreateNoteInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createNote(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNNote2ᚖWISPᚋinternalᚋadaptersᚋgraphqlᚋmodelᚐNote(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_notes(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Note)
	fc.Result = res
	return ec.marshalNNote2ᚕᚖWISPᚋinternalᚋadaptersᚋgraphqlᚋmodelᚐNoteᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_note(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Note)
	fc.Result = res
	return ec.marshalONote2ᚖWISPᚋinternalᚋadaptersᚋgraphqlᚋmodelᚐNote(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNCreateNoteInput2WISPᚋinternalᚋadaptersᚋgraphqlᚋmodelᚐCreateNoteInput(ctx context.Context, v interface{}) (model.CreateNoteInput, error) {
...
func (ec *executionContext) marshalNNote2WISPᚋinternalᚋadaptersᚋgraphqlᚋmodelᚐNote(ctx context.Context, sel ast.SelectionSet, v model.Note) graphql.Marshaler {
	return ec._Note(ctx, sel, &v)
}

func (ec *executionContext) marshalNNote2ᚕᚖWISPᚋinternalᚋadaptersᚋgraphqlᚋmodelᚐNoteᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Note) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNNote2ᚖWISPᚋinternalᚋadaptersᚋgraphqlᚋmodelᚐNote(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNNote2ᚖWISPᚋinternalᚋadaptersᚋgraphqlᚋmodelᚐNote(ctx context.Context, sel ast.SelectionSet, v *model.Note) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalONote2ᚖWISPᚋinternalᚋadaptersᚋgraphqlᚋmodelᚐNote(ctx context.Context, sel ast.SelectionSet, v *model.Note) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Note(ctx, sel, v)
